...
EFI_STATUS efi_main (EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable) {
	...
	InitializeLib(ImageHandle, SystemTable); // Initialize the EFI library
	Print(L"String \n\r"); // Print a string to the screen
	...
	{
		Print(L"kernel.elf is not a valid 64-bit x86 ELF executable \n\r");
	} else {
		Print(L"kernel.elf is a valid 64-bit x86 ELF executable \n\r");
	}
